...
public class EduIntro2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_edu_intro2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        /*if(nivel.equals("5")){
            eduintro.setImageResource(R.drawable.eduintro_palmas);
            eduintro_title.setImageResource(R.drawable.title_eduintro_palmas);
        ...
        img_back_arrrow = getActivity().findViewById(R.id.atras_intro1);
        ...
        btn_comenzar = getActivity().findViewById(R.id.btn_eduintro_arboles);
